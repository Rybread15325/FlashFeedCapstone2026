      ...
      <div className="flex items-center gap-2 flex-shrink-0">
        ...
        {a.sentiment && (
          <span className={clsx(
            ...
            a.sentiment === 'bullish' && 'bg-emerald-500/20 border-emerald-500 text-emerald-300',
            a.sentiment === 'bearish' && 'bg-red-500/20 border-red-500 text-red-300',
            a.sentiment === 'neutral' && 'bg-slate-500/20 border-slate-500 text-slate-300',
          )}>
            {sentLabel}
          </span>
        )}
