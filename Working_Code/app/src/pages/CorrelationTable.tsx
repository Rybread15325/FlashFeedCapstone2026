        ...
        <thead className="border-b border-border">
          <tr>
            {[
              ...
              { key: 'correlation' as keyof CorrelationEntry, label: 'ALIGNMENT' },
              { key: 'direction' as keyof CorrelationEntry, label: 'SIGNAL' },
              { key: 'news_sentiment' as keyof CorrelationEntry, label: 'NEWS SENT' },
              ...
              { key: 'confidence' as keyof CorrelationEntry, label: 'CONF' },
            ].map(({ key, label }) => (
