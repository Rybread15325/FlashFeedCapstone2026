    ...
    <div>
      <div className="flex items-center justify-between mb-4">
        <div>
          ...
          <div className="text-neutral text-xs mt-0.5">
            Latest quote snapshot alignment. True Pearson correlation requires intraday bars plus rolling social density.
          </div>
        </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-2 mb-4">
        ...
        <Metric label="Avg |Alignment|" value={avgAbs ? avgAbs.toFixed(3) : '--'} tone="text-yellow-300" />
